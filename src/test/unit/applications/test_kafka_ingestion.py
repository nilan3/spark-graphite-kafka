...
class TestMethod(unittest.TestCase):
    ...
    def test_sum(self):
        ...
        :return:
        """
        config_path = "/odh/python/test/unit/resources/test_sum_configurations.yml"
        input = [
            {
                "datapoints": [
    ...
    def test_avg(self):
        ...
        :return:
        """
        config_path = "/odh/python/test/unit/resources/test_avg_configurations.yml"
        input = [
            {
                "datapoints": [
                    [38.88631905155365, 1528294230],
